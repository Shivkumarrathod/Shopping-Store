...
const ProductUpdate = () => {
    ...
    const [uploadProductImage] = useUploadProductIamgeMutation()
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
          ...
          console.error(error)
          toast.error("Product updating failed. try Again! ")
        }
    }
      ...
      <div className="p-3">
          ...
          <div className="flex justify-between">
              ...
              <div>
                  ...
                  <select placeholder='Choose Category' className="p-4 mb-3 w-[30rem] border rounded-lg bg-[#101011] text-white" 
