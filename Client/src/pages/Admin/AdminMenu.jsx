...
const AdminMenu = () => {
  ...
  return (
    <div>
      <button className={`${isMenuOpen ? 'top-2 right-2 ' :'top-5 right-7'} bg-[#151515]
      ...
      {isMenuOpen &&(
        <section className="bg-[#151515] p-4 fixed right-9 top-12">
            <ul className="list-none mt-2">
              ...
              <li>
                <NavLink className='list-item py-2 px-3 block mb-5 hover:bg-[#2E2D2D] rounded-sm' 
                 to='/admin/allproductlist' style={({isActive})=>({
                    color:isActive ? "greenyellow" :"white"
                 })}>
                    All products
                 </NavLink>
